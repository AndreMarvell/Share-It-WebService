...
namespace Covoiturage\RateCommentBundle\Form\DataTransformer;
...
class CommentThreadTransformer implements DataTransformerInterface
{
    ...
    {
        $this->om = $om;
        $this->setEntityClass("Covoiturage\RateCommentBundle\Entity\CommentThread");
        $this->setEntityRepository("CovoiturageRateCommentBundle:CommentThread");
